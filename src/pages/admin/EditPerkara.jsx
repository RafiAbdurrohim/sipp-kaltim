        ...
        if (found)
          if (found)
            setForm({
              ...
              tglPemeriksaan: found.tgl_pemeriksaan?.split("T")[0] || "",
              tglBanding: found.tgl_banding?.split("T")[0] || "",
              tglKasasi: found.tgl_kasasi?.split("T")[0] || "",
              tglPk: found.tgl_pk?.split("T")[0] || "",
              tglSelesai: found.tgl_selesai?.split("T")[0] || "",
