          ...
          >
            ...
            <div style={{ maxWidth: 320 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
                ...
                >
                  <img src="https://upload.wikimedia.org/wikipedia/commons/b/bc/Coat_of_arms_of_East_Kalimantan.svg" alt="Logo Kaltim" style={{ width: 42, height: 42, objectFit: "contain" }} />
                </div>
                <div>
